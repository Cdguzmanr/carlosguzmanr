...
const base = "/src/assets/images/projects"; // Base path for images if needed
...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    featured: false,
    title: "The Hobby Hub",
    images: [`${base}/TheHobbyHubHome.png`],
  ...
  },
  {
    ...
    featured: false,
    title: "Grocery List",
    images: [`${base}/GroceryListDemo.png`],
  ...
  },
  {
    ...
    featured: false,
    title: "Gallery App",
    images: [`${base}/GalleryAppDemo.jpg`],
  ...
  },
  {
    ...
    images: [`${base}/OCEPI-Contact1.png`],
  ...
  },
  {
    ...
    images: [`${base}/ICACHome.jpeg`, `${base}/ICACMeetingTimes.jpg`],
  ...
  },
  {
    ...
    images: [`${base}/NCJTCHome.jpeg`, `${base}/NCJTCPayments01.png`, `${base}/NCJTCPayments02.png`],
